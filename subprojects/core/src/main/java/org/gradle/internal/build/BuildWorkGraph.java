...
public interface BuildWorkGraph {
     ...
     *
     * <p>This method does not schedule the task for execution, use {@link #schedule(ExportedTaskNode)} to schedule the task.
     */
    ...
    /**
     * Schedules a task and all of its dependencies in this build's work graph.
     */
    void schedule(ExportedTaskNode taskNode);
